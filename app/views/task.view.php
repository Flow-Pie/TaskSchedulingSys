...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Outfit:wght@400;500;700&display=swap" rel="stylesheet"><!-- Outfit Font -->
...
<body>
    <nav class="sidebar menu" aria-label="Sidebar Navigation">
        ...
        <a href="#" aria-label="Dashboard"><img src="<?php echo ROOT; ?>assets/images/dashboard.png" alt="Dashboard Icon">Dashboard</a>
        <a href="#" aria-label="Tasks"><img src="<?php echo ROOT; ?>assets/images/clipboard.png" alt="Task Icon">Task</a>
        <a href="#" aria-label="New Task"><img src="<?php echo ROOT; ?>assets/images/signature.png" alt="New Task Icon">New Task</a>
        <a href="#" aria-label="Reports"><img src="<?php echo ROOT; ?>assets/images/bar-chart.png" alt="Reports Icon">Reports</a>


        <div class="profile" role="region" aria-label="User Profile">
            <div class="profile-pic">
                <img src="<?php echo ROOT; ?>assets/images/man.png" alt="User Profile Picture">
            </div>
            <div class="profile-info">
                <div>Logged In As: <span>User</span></div>
                <div>Access Level: <span>High</span></div>
                <div><span>2:30:59 AM</span></div>
            </div>
        </div>
    </nav>
    ...
    <div class="content main" aria-label="Main Content">
                ...
                <div class="time">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-content">
                            <a href="#" aria-label="Edit Task">Edit<i class="fa-regular fa-pen-to-square"></i></a>
                            <a href="#" aria-label="Delete Task">Delete<i class="fa-solid fa-trash"></i></a>
                            <a href="#" aria-label="Mark Task as Done">Mark as Done<i class="fa-regular fa-circle-check"></i></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <button class="add-task-btn">
            <a href="new-task.html" aria-label="Add Task" type="button"><i class="fa-solid fa-plus"></i><span>Add Task</span> </button>
    </div>
